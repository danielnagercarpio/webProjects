            ...
            <div className='mobile-content'>
                ...
                <form className='mobile-login-form-section'
                    ...
                    <div className='mobile-login-inputs'>
                        ...
                        <div className='mobile-password'><i class="fa-solid fa-lock"></i><input type="password" name="password" placeholder='password'/></div>                    
                    </div>                 
            ...
            <div className='pc-content'>
                ...
                >
                    ...
                    <div className='pc-login-inputs'>
                        ...
                        <div className='pc-password'><i class="fa-solid fa-lock"></i><input type="password" name="password" placeholder='password'/></div>                    
                    </div>                 
